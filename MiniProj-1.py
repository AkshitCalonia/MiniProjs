# Make a game - Mad Libs Generator
...
Button(root, text= 'THE PHOTOGRAPHER', font = 'arial 15 italic', command = madlib1, bg = 'ghost white').place(x=60, y=120)

Button(root, text= 'Apple and apple', font = 'arial 15 italic', command = madlib3, bg = 'ghost white').place(x=70, y=180)

Button(root, text= 'The Butterfly', font = 'arial 15 italic', command = madlib2, bg = 'ghost white').place(x=80, y=240)
